...
const Add = () => {
    ...
    try {
      ...
      if (response.data.success) {
        ...
        setData({ 
          ...
          description: "", 
          price: "", 
          category: data.category // Keep same category
        });
        setImage(false);
      } else {
  ...
  const getImagePreview = () => {
    return !image ? assets.upload_area : URL.createObjectURL(image);
  };
    ...
    <div className="add">
      <form className="add-form" onSubmit={handleSubmit}>
        ...
        <div className="add-header">
          ...
          <p className="add-subtitle">Fill in the details below to add a new product</p>
        </div>

        {/* Image Upload Section */}
        <div className="add-section">
          <label className="add-label">Product Image</label>
          <p className="add-hint">Click the area below to upload an image</p>
